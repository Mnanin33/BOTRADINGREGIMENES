...
# 1. ESTO DEBE IR PRIMERO: Configuración global
st.set_page_config(page_title="Bot Adaptativo Pro", layout="wide")

# 2. INYECCIÓN DE CSS (para fijar la sidebar)
st.markdown(
    """
    <style>
        /* Oculta el botón de colapsar (la flecha) */
        [data-testid="collapsedControl"] {
            display: none
        }
        /* Fuerza la visibilidad de la barra lateral */
