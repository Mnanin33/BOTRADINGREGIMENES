...
st.set_page_config(page_title="Bot Adaptativo Pro", layout="wide")
    ...
    # CSS para limpieza profunda de interfaz
st.markdown("""
        <style>
        /* Oculta los elementos de despliegue y pie de página de Streamlit */
        #MainMenu, footer, header {visibility: hidden;}
        
        /* Oculta específicamente el botón 'Manage app' y otros botones flotantes */
        .stAppDeployButton, .stDeployButton, div[data-testid="stDecoration"], 
        div[data-testid="stToolbar"], div[data-testid="stHeader"] {
            display: none !important;
        }
        
        /* Asegura que la barra lateral permanezca visible y funcional */
...
diccionario = {
    "Español 🇪🇸": {
        ...
        "secret_key": "Secret Key del Exchange",
        ...
        "hist_tit": "🗄️ Historial Reciente de Auditoría",
...
if not st.session_state["autenticado"]:
    ...
    # =====================================================================
    # VISUALIZADOR DE BASE DE DATOS (EXCLUSIVO PARA EL ROL ADMIN DINÁMICO)
    # =====================================================================
    usuario_logueado = st.session_state.get("usuario_actual", "")
    
    # Extraemos el usuario maestro definido en secrets dinámicamente
    try:
        admin_real = st.secrets["auth"]["user"]
    except Exception:
        admin_real = "admin"
        
    if usuario_logueado and usuario_logueado.lower() == admin_real.lower():
        st.markdown("---")
