...
def inicializar_base_datos():
    ...
    # Agrega las columnas nuevas si el archivo de BD ya existía de antes
    try:
...
# Inicializamos la base de datos al arrancar la aplicación aplicando el parche si es necesario
