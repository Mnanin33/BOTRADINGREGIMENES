...
st.markdown(
    """
    <style>
    /* Oculta el menú superior de Streamlit */
    #MainMenu {visibility: hidden;}
    
    /* Oculta el header (la barra superior que suele aparecer) */
    header {visibility: hidden;}
    
    /* Oculta el pie de página */
    footer {visibility: hidden;}
    
    /* Oculta el botón 'Manage app' de abajo a la derecha */
    .stAppDeployButton {display: none !important;}
    
    /* Oculta el botón de despliegue principal */
    .stDeployButton {display: none !important;}
    
    /* Oculta la decoración decorativa superior */
